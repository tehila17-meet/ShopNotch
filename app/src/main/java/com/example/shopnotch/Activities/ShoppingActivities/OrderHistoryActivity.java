...
public class OrderHistoryActivity extends AppCompatActivity {
    ...
    private void populateRecyclerView() {
        ...
        adapter =new FirestoreRecyclerAdapter<PlacedOrderModel, OrderHistoryActivity.ProductView>(response) {
            @Override
            protected void onBindViewHolder(@NonNull OrderHistoryActivity.ProductView holder, final int position, @NonNull final PlacedOrderModel model) {
            ...
            @NonNull
            @Override
            public OrderHistoryActivity.ProductView onCreateViewHolder(@NonNull ViewGroup group, int viewType) {
