...
public class OrderTrackActivity extends AppCompatActivity {
    ...
    private void populateRecyclerView() {
        ...
        adapter = new FirestoreRecyclerAdapter<SingleProductModel, OrderTrackActivity.ProductView>(response) {
            @Override
            protected void onBindViewHolder(@NonNull OrderTrackActivity.ProductView viewHolder, final int position, @NonNull SingleProductModel model) {
            ...
            @NonNull
            @Override
            public OrderTrackActivity.ProductView onCreateViewHolder(@NonNull ViewGroup group, int viewType) {
                Log.d(TAG,"Inflating Layout");
                View view = LayoutInflater.from(group.getContext())
                        .inflate(R.layout.order_track_item_layout, group, false);

                return new OrderTrackActivity.ProductView(view);
